...
private:
    ...
    static constexpr auto make_dispatch_table() {
        return make_dispatch_table_impl<Visitor>(make_index_sequence<sizeof...(Types)>());
    }
